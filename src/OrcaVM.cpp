...
void dump_code(std::vector<InstructionCode> code_list)
{
    ...
    for(auto code:code_list)
    {
        switch(code.type)
        {
            ...
            case InstructionCodeType::G_Store_A: std::cout<<code_cnt<<" : [G_Store_A] : "<<code.opr_i<<std::endl; break;
            ...
            case InstructionCodeType::G_Load_A: std::cout<<code_cnt<<" : [G_Load_A] : "<<code.opr_i<<std::endl; break;
            ...
            case InstructionCodeType::G_AStore_A: std::cout<<code_cnt<<" : [G_AStore_A] : "<<code.opr_i<<std::endl; break;
            ...
            case InstructionCodeType::G_ALoad_A: std::cout<<code_cnt<<" : [G_ALoad_A] : "<<code.opr_i<<std::endl; break;
            ...
            case InstructionCodeType::AStore_A: std::cout<<code_cnt<<" : [AStore_A] : "<<code.opr_i<<std::endl; break;
